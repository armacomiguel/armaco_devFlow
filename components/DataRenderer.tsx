...
const StateSkeleton = ({image, title, message, button}: StateSkeletonProps) => (
    <div className='mt-16 flex w-full flex-col items-center justify-center sm:mt-36'>
        ...
        <p className='body-regular text-dark500_light700 my-3.5 max-x-md text-center'>{message}</p>
        {button && (
            <Button className='paragraph-medium mt-5 min-h-[46px] rounded-lg cursor-pointer
            dark:bg-white px-4 py-3 !text-light900 bg-primary-500 hover:bg-primary-500'>
