    ...
    <>
        ...
        <div className='flex justify-end max-sm:mb-5 max-sm:w-full sm:mt-3'>
          {loggedInUser?.user?.id === id && (
            <Link href="/profile/edit">
              <Button className='paragraph-medium btn-secondary text-dark300_light900 min-h-12 min-w-44 px-4 py-3'>Editar perfil</Button>
            </Link>
          )}
        </div>
      </section>
      ...
      <section className='mt-10 flex gap-10'>
        <Tabs defaultValue="top-posts" className="flex-[2]">
          ...
          <TabsContent value="answers" className='flex w-full flex-col gap-6'>Lista de respuestas</TabsContent>
        </Tabs>
        
        <div className='flex w-full min-w-[250px] flex-1 flex-col max-lg:hidden'>
          <h3 className='h3-bold text-dark200_light900'>Top Etiquetas</h3>
