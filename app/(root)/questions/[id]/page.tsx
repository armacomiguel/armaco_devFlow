  ...
  return (
    <>
      ...
      <div className='mb-8 mt-5 flex flex-wrap gap-4'>
        <Metric imgUrl='/icons/clock.svg' alt='clock icon'
          value={` preguntado ${getTimeStamp(new Date(createdAt))}`}
          title=""
          textStyles='small-regular text-dark400_light700'
        />
        <Metric imgUrl='/icons/message.svg' alt='message icon'
          value={answers}
          title=""
          textStyles='small-regular text-dark400_light700'
        />
        <Metric imgUrl='/icons/eye.svg' alt='eye icon'
